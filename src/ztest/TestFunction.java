...
//    MultivariateQuadFunction f12 = new MultivariateQuadFunction("x2");
//    f12.getCoefficients().put("x1", "x1", 1.0);
//    f12.getCoefficients().put("x1", "", 1.0);    
//    f12.getCoefficients().put("x2", "x2", 4.0);
//    f12.getCoefficients().put("x2", "", 2.0);
//    f12.getCoefficients().put("x1", "x2", 2.0);
//    f12.getCoefficients().put("", "", 3.0);
//    Map<String, Interval> intervalMap12 = new HashMap<>();
//    intervalMap12.put("x1", globalInterval);
//    intervalMap12.put("x2", globalInterval);
...
//    MultivariateQuadFunction f13 = new MultivariateQuadFunction("x3");
//    f13.getCoefficients().put("x1", "x1", 1.0);
//    f13.getCoefficients().put("x1", "", 1.0);    
//    f13.getCoefficients().put("x3", "x3", 9.0);
//    f13.getCoefficients().put("x3", "", 3.0);
//    f13.getCoefficients().put("x1", "x3", 3.0);
//    f13.getCoefficients().put("", "", 4.0);
//    Map<String, Interval> intervalMap13 = new HashMap<>();
//    intervalMap13.put("x1", globalInterval);
//    intervalMap13.put("x3", globalInterval);
...
//    MultivariateQuadFunction f23 = new MultivariateQuadFunction("x3");
//    f23.getCoefficients().put("x2", "x2", 4.0);
//    f23.getCoefficients().put("x2", "", 2.0);    
//    f23.getCoefficients().put("x3", "x3", 9.0);
//    f23.getCoefficients().put("x3", "", 3.0);
//    f23.getCoefficients().put("x2", "x3", 6.0);
//    f23.getCoefficients().put("", "", 5.0);
//    f23.setOwner("x3");
//
//    Map<String, Interval> intervalMap23 = new HashMap<>();
//    intervalMap23.put("x2", globalInterval);
//    intervalMap23.put("x3", globalInterval);
...
//    MultivariateQuadFunction f24 = new MultivariateQuadFunction("x4");
//    f24.getCoefficients().put("x2", "x2", 4.0);
//    f24.getCoefficients().put("x2", "", 2.0);    
//    f24.getCoefficients().put("x4", "x4", 16.0);
//    f24.getCoefficients().put("x4", "", 4.0);
//    f24.getCoefficients().put("x2", "x4", 8.0);
//    f24.getCoefficients().put("", "", 6.0);
//    f24.setOwner("x4");
//    Map<String, Interval> intervalMap24 = new HashMap<>();
//    intervalMap24.put("x2", globalInterval);
//    intervalMap24.put("x4", globalInterval);
...
//    label12.add("x1"); label12.add("x2");
//    TableDouble util32 = new TableDouble(label12);
//    List<Double> values = new ArrayList<>();
//    values.add(4.103543);
//    values.add(4.675046);
//    util32.addRow(new RowDouble(values, 291.253351));
//    values.clear();
//    values.add(3.909459);
//    values.add(2.226753);
//    util32.addRow(new RowDouble(values, 250.243753));
//    values.clear();
//    values.add(1.623590);
//    values.add(3.471825);
//    util32.addRow(new RowDouble(values, 251.765419));
//    values.clear();
//    
//    List<String> label2 = new ArrayList<>();
//    label2.add("2");
//    TableDouble util42 = new TableDouble(label2);
//    values.add(5.394787);
//    util42.addRow(new RowDouble(values, 373.998955));
//    values.clear();
//    values.add(2.209659);
//    util42.addRow(new RowDouble(values, 198.151543));
//    values.clear();
//    values.add(3.802223);
//    util42.addRow(new RowDouble(values, 281.002727));
//    values.clear();
//    
////    values.add(5.394787);
//    values.add(2.209659);
...
//    out.println(util42);
//    
//    TableDouble joinedTable = DPOP_UTIL.joinTable(util32, util42);
...
//  }
  ...
  void testUnaryInterpolatingFunction() {
    out.println("TESTING testUnaryInterpolatingFunction()");
    List<String> unaryLabel = new ArrayList<>();
    unaryLabel.add("1");
    
    TableDouble unaryTable = new TableDouble(unaryLabel);

    unaryTable.addRow(new RowDouble(new double[] {1}, 1.0));
    unaryTable.addRow(new RowDouble(new double[] {2}, 2.0));
    unaryTable.addRow(new RowDouble(new double[] {3}, 3.0));
    ...
    out.println("Interpolation from table: " + unaryTable);
    out.println("Interpolating point: " + interpolatedPoint);
    RowDouble interpolatedRow = unaryTable.inverseWeightedInterpolation(interpolatedPoint, stepsize);
    out.println("Interpolating point that is already in the table: " + interpolatedPointInTable);
    RowDouble interpolatedRowInTheTable =  unaryTable.inverseWeightedInterpolation(interpolatedPointInTable, stepsize);
    
    RowDouble rowToCompare = new RowDouble(new double[] {4}, 26.0/11);
    
    assert (interpolatedRow.equals(rowToCompare));
    assert (unaryTable.getRowList().contains(interpolatedRowInTheTable));
    out.println("DONE TESTING testUnaryInterpolatingFunction()");
  }
...
//  @Test
  void testAnalyticalProjectDPOP() {
    out.println("TESTING testAnalyticalProjectDPOP()");
    ...
    out.println("DONE TESTING testAnalyticalProjectDPOP()");
  }
...
//  @Test 
  /**
   * UNIT TEST this function only when Approximate DPOP is in use
   */
  void testApproxProjectDPOP() {
    out.println("TESTING testApproxProjectDPOP()");
    String owner = "1";
    ...
    out.println("Before APPROX projecting: " +  f);
    PiecewiseMultivariateQuadFunction approxFunc = f.approxProject(2, "1", 2, true); 
    
    out.println("After APPROX projecting: " +  approxFunc);
    out.println("DONE TESTING testApproxProjectDPOP()");
  }
...
//  @Test
  ...
  @Test
  void interpolate() {
    out.println("TESTING interpolate()");
    List<String> label = new ArrayList<>();
    label.add("x1");
    label.add("x4");
    TableDouble table = new TableDouble(label);
    
    List<Double> valueList = new ArrayList<>();
    valueList.add(2.2);
    valueList.add(0.4);
    table.addRow(new RowDouble(new ArrayList<>(valueList), 96.97));
    
    valueList.clear();
    valueList.add(-1.3);
    valueList.add(-1.4);
    table.addRow(new RowDouble(new ArrayList<>(valueList), 57.80));
    
    valueList.clear();
    valueList.add(2.1);
    valueList.add(1.8);
    table.addRow(new RowDouble(new ArrayList<>(valueList), 148.37));
    
    valueList.clear();
    valueList.add(-1.4);
    valueList.add(-0.3);
    table.addRow(new RowDouble(new ArrayList<>(valueList), 24.13));
    
    valueList.clear();
    valueList.add(1.5);
    valueList.add(0.5);
    table.addRow(new RowDouble(new ArrayList<>(valueList), 81.52));

    valueList.clear();
    valueList.add(-2.3);
    valueList.add(2.7);
    table.addRow(new RowDouble(new ArrayList<>(valueList), -93.22));
    ...
    double[] argmax = table.maxArgmaxHybrid(valueMap, interval.getMidPointInHalfIntegerRanges());
    System.out.println(argmax[1]);
    out.println("DONE TESTING interpolate()");
  }
...
//
//    MultivariateQuadFunction func11 = new MultivariateQuadFunction("x1");
