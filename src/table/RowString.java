 ...
 *
 */
public class RowString extends AbstractRow implements Serializable {
	/**
	 * 
	 */
	...
	public RowString(RowString newRow) {
	...
	//input: X1, X2, X3,...,Xn
	//input utility
	public RowString(List<String> input, double utility) {
		this.valueList.addAll(input);
		this.utility = utility;
	}
	
	public RowString(List<String> decisionVariableList, List<String> randVariableList, double utility) {
		this.valueList.addAll(decisionVariableList);
		this.randomList.addAll(randVariableList);
		this.utility = utility;
	}
	
	public RowString(List<String> decisionAndRandomList, int noDecision, double utility) {
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof RowString)) {
      return false;
    }
    RowString other = (RowString) obj;
